 ...
 */
export const nobleECPair: ECPairAPI = {
  fromPublicKey(
 ...
 */
export function wrapHDKey(hdkey: HDKey, network: Network): BIP32Interface {
 ...
 */
export const scureBIP32: BIP32API = {
